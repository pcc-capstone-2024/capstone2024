class Buzz {
    constructor(x, y, targetX, targetY, a, b/*, red, green, blue*/) {
        ...
        this.bee = loadImage('assets/bee.png');
    }
    ...
    makeBuzz() {
        ...
        image(this.bee, this.loc.x, this.loc.y);
...
class Swarm{
    constructor(personal, social, inertia, r1, r2, buzzezMany){
        ...
        for(let i = 0; i < this.buzzezMany; i++){
            ...
            this.randA = this.randX - random(3, 30);
            this.randB = this.randY - random(3, 30);
    ...
    updateParticles() {
        ...
        if(this.c1 < 1.9 && frameCount % 10 > 5){
            this.c1 += 0.3;
            // this.c1 % 2;
        }
        if(this.c1 > 0.3 && frameCount % 10 > 5){
            this.c1 -= 0.3;
            // this.c1 % 2;
        }
        if(this.c2 < 1.9 && frameCount % 10 > 5){
            this. c2 += 0.3;
            // this.c2 = this.c2 % 2;
        }
        if(this.c2 > 0.3 && frameCount % 10 > 5){
            this.c2 -= 0.3;
            // this.c2 % 2;
        }
        console.log(c1);
    ...
    // updateParticles2(targetX, targetY){ ////flock
    //     // push();
    //         translate(this.headX, this.headY);
    //         for(let i = 0; i < this.buzzezMany; i++){
